		...
		<nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li><a class="active-menu" href="messages"><i
									...
									<div class="media-body">
										<c:forEach var="users" items="${connectionList}">
											<div class="media">
												...
												<div class="media-body">
													<h5>
														<a href="populateMessages" id="coupleName" class="coupleName">"${users}"
															| User</a>
													</h5>
												...
												$(".chat-window")
														.append(
																"<li class='media'> <div class='media-body'><div class='media'><a class='pull-left' href='#'>"
																		+ "<img class='media-object img-circle ' src='assets/img/user.gif' /></a><div class='media-body' >"
																		+ message
