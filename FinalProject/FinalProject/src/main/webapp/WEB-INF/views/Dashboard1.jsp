					...
					<div class="row">
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<i class="fa fa-map-marker "></i> <input type="text"
										class="form-control" id="curr-loc"
										placeholder="Enter Current Location" name="location"
						...
						<div class="col-sm-9" contenteditable="false" style="">
							<div class="panel panel-default">
								<div class="panel-heading">Our Story</div>
								<div class="panel-body">
									<textarea class="form-control" name="story"
										value="${coupleInfo.story}" rows="3">${coupleInfo.story}</textarea>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">Activities we like</div>
