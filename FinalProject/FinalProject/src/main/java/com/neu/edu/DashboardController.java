...
public class DashboardController {
	...
	public String dashbboardEditProfile(Model model, HttpServletRequest request){
		...
		System.out.println("checkig the actvity string size " + actSel.length);
		ArrayList<Activities> activitiesList = (ArrayList<Activities>) coupleInfoDAO.retreiveActivity(actSel);
	...
	public String uploadFileHandler(@RequestParam("file") CommonsMultipartFile file, HttpServletRequest request) throws IllegalStateException, IOException {
		...
		File dest = new File("/Users/kshitij/Desktop/FinalWebProject/images/"+coupleName+".jpg");
